<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="DAppointment.aspx.vb" Inherits="DAppointment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="text-center">
        ...
        <br />
         ...
         <br />
        <br />
        <span style="color: #FFFFFF"><strong>Patient<br />
        <asp:DropDownList ID="DropDownList1" runat="server" Width="180px" CssClass="form-control-static">
        </asp:DropDownList>
        <br />
        <br />
        Date<br />
        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="100%" CssClass="form-control-static">
